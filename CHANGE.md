...
- **New feature**
    ...
    2. Add remote upgrade function for external extension.
    ...
    10. Add timeout error in upload modal. If it gets stuck for tens of seconds. Show timeout error allow users to click the close button but not stuck forever.
    11. Add arduino uno ultra to support customized board witch A6 A7 pins.
    12. Optimize the external extension framwork.
